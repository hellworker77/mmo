...
{
    public byte MinSocketsCount { get; set; }
    
    public byte MaxSocketsCount { get; set; }
    ...
    public ushort Resilience { get; set; }
    ...
    public virtual IList<CharacterItem> OwnedItems { get; set; }
